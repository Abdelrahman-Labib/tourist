...
{{--{{dd($errors)}}--}}
    <div class="page-content-wrap">
        ...
        <div class="row">
            <div class="col-md-12">
                <form class="form-horizontal" action="/admin/settings/term/update" method="post">
                    {{csrf_field()}}
                            ...
                            <div class="form-group {{ $errors->has('ar_text') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="input-group">
                                        ...
                                        <textarea class="form-control" name="ar_text" rows="5">{{$term->ar_text }}</textarea>
                                    </div>
                        ...
                        <div class="panel-body">
                            <div class="form-group {{ $errors->has('en_text') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="input-group">
                                        <span class="input-group-addon"><span class="fa fa-file-text"></span></span>
                                        <textarea class="form-control" name="en_text" rows="5">{{$term->en_text }}</textarea>
                                    </div>
